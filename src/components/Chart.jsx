...
class Chart extends Component {
  render () {
    let color = d3.scale.ordinal().range(['#EDC951'])
    ...
    function RadarChart (id, data, options) {
      let size = window.innerWidth,
        ...
        phablet = window.matchMedia(
          '(min-width: 430px) and (max-width: 600px)'
        ),
      ...
      // Put all of the options into a letiable called chart
      ...
      // ========================================================================
      svgNode = ReactFauxDOM.createElement('div')
      ...
      let g = svg
        ...
        .attr(
          'transform',
          'translate(' +
            (chart.w / 2 + chart.margin.left) +
            ',' +
            (chart.h / 2 + chart.margin.top) +
            ')'
        )
      ...
      axis
        ...
        .attr('x', function (d, i) {
          return (
            rScale(maxValue * chart.labelFactor) *
