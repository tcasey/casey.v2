      ...
      <div className='menu-wrapper'>
        ...
        >
          <svg width='70' height='40' className='Layer_2' x='0px' y='0px' viewBox='0 524.5 2000 2000.5' enableBackground='new 0 524.5 2000 2000.5' >
            ...
            <path className='yy' fill='none' stroke='' strokeMiterlimit='10' d='M1410.5,1524.7c0,0-821.2,0-821.2,0c-211.3,0-260,98-218.2,217.6l0,0.1c90.1,260.7,337.6,447.9,628.9,447.9c367.4,0,665.2-297.8,665.2-665.2c0-79-13.8-154.8-39.1-225.2' />
            <path className='yy' fill='none' stroke='' strokeMiterlimit='10' d='M589.3,1524.7c0,0,821.2,0,821.2,0c211.3,0,260-98,218.2-217.6l0-0.1c-90.1-260.7-337.6-447.9-628.9-447.9c-367.4,0-665.2,297.8-665.2,665.2c0,79,13.8,154.8,39.1,225.2' />
          </svg>
        </div>
        <nav className={this.state.menu ? 'menu' : 'menu-hide'}>
